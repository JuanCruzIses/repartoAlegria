...
return(
        <div className="bg-white relative h-full pb-200px">
            <p className="flex items-center justify-center text-2xl font-medium text-center font-serif bg-black text-white">Granja</p>                
            <Link href='/productos/granja'>
            <div className="relative flex border-b-[1px] md:h-[7%]">
                <button className="p-[5px]"><IoIosArrowBack/></button>
                <p className="flex items-center text-[18px]">Granja</p>
            </div>
            </Link>
            <div className="px-[2%]">
            {isLoading || !product  ? (
