...
export default function Almacenygranja(){
...
return(
    <div className="bg-white relative h-full">
        <ToastContainer/>
        <p className="flex items-center justify-center text-2xl font-medium text-center font-serif bg-black text-white h-[5vh] lg:h-[7vh]"><GiChicken className="px-1 text-[30px] mx-[1%]"/>Granja<GiChicken className="px-1 text-[30px] mx-[1%]"/></p>                
        <Link href={"/productos"}>
